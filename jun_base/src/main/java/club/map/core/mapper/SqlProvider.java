...
import club.map.core.model.orm.FieldColumn;
import club.map.core.util.BeanUtil;
...
public class SqlProvider {
    ...
    public String updateByFilterForUpdate(final Object object, final DAOFilter filter) {
        return updateByFilter(object, filter, true);
    }

    public String updateByFilterForDelete(final Object object, final DAOFilter filter) {
        return updateByFilter(object, filter, false);
    }

    public String updateByFilter(final Object object, final DAOFilter filter, Boolean isUpdate) {
        ...
        String sql = new SQL() {
            {
                ...
                for (FieldColumn fc : BeanUtil.getFieldsWithReturnValue(object)) {
                    ...
                    if (isUpdate && column.equals("using_type")) {
                        continue;
                    }
