package club.map.core.manager.impl;

import club.map.core.manager.GenericManager;
import club.map.core.mapper.GenericMapper;
import club.map.core.model.*;
...
public class GenericManagerImpl<T extends RootObject, ID extends Serializable> implements GenericManager<T, ID> {
    ...
    @Override
    public void updateField(T object, String[] fields) {
        mapper.updateFields(object,fields);
    }
    ...
    public void removeLogic(DAOFilter filter){
        try {
            ...
            obj.setUsingType(UsingType.logic_delete.getCode());
            mapper.updateByFilterForDelete(obj, filter);
