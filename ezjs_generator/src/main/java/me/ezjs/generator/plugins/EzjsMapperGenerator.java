...
public class EzjsMapperGenerator extends AbstractJavaGenerator {
    ...
    private static final String GENERIC_MAPPER = "GenericMapper";
    private static final String GENERIC_MANAGER = "GenericManager";
    private static final String GENERIC_MANAGER_IMPL = "GenericManagerImpl";
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        sqlProviderClass.addImportedType(new FullyQualifiedJavaType("SqlProvider"));
