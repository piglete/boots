...
//
//    private static Logger logger = Logger.getLogger(FolderUtils.class.getName());
//
//    /*
//     *
//     * Ftp构造函数
//     */
//    public FolderUtils(String strIp, int intPort, String user, String Password) {
//        this.strIp = strIp;
...
//        FolderUtils ftp = new FolderUtils("192.168.50.32", 21, "zjx", "zjx");
//        ftp.ftpLogin();
...
//        //下载文件夹
//        ftp.downLoadDirectory("D:\\ics文件\\111\\", "upload\\record\\2019\\4\\长治市");
//        ftp.ftpLogOut();
//    }
//}
