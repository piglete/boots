package com.bych.v_s_pressure.mapper.sqlprovider;
...
public class VSPressureProvider extends SqlProvider {
    protected final Log log = LogFactory.getLog(getClass());

    public String getLastData(String sn, String deviceName,String regionCode) {
        String sql = "select x1.* from v_s_pressure x1,(select t.equ_id ,max(t.observe_time) as observe_time from v_s_pressure t group by t.equ_id) x2  " +
